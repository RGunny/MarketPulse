package me.rgunny.marketpulse.event.watchlist.application.port.out;
...
public interface WatchTargetPort {
     ...
     */
    Flux<WatchTarget> findActiveTargetsByCategory(me.rgunny.marketpulse.event.watchlist.domain.model.WatchCategory category);
