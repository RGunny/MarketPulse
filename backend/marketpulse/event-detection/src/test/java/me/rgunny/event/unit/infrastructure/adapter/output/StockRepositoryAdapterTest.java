...
import me.rgunny.event.marketdata.infrastructure.adapter.out.shared.StockRepository;
import me.rgunny.event.marketdata.infrastructure.adapter.out.shared.StockRepositoryAdapter;
...
class StockRepositoryAdapterTest {
    ...
    class UpdateTest {
        ...
        void givenStock_whenUpdate_thenReturnsUpdatedStock() {
            ...
            // when
            Mono<Stock> result = stockRepositoryAdapter.update(updatedStock);
